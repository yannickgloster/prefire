            ...
            try {
                ...
                if (response_stats.ok) {
                    ...
                    if (statsData.items && statsData.items.length > 0) {
                        ...
                        console.log(`Average kills (last ${matchCount} matches):`, playerData.avgKills.toFixed(2))
                        console.log(`Average ADR (last ${matchCount} matches):`, playerData.avgADR.toFixed(2))
                    }
                }
    ...
    return (
        <a
            ...
            {faceitData.avgKills !== undefined && faceitData.avgADR !== undefined && (
                <>
                    <br />
                    Avg Kills: {faceitData.avgKills.toFixed(1)}, Avg ADR: {faceitData.avgADR.toFixed(1)}
                </>
            )}
        </a>
    )
